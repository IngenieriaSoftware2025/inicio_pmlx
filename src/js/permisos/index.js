...
const cargarUsuarios = async () => {
    const url = `/inicio_pmlx/permisos/buscarUsuariosAPI`;
    const config = {
        method: 'GET'
    }
...
const cargarAplicaciones = async () => {
    const url = `/inicio_pmlx/permisos/buscarAplicacionesAPI`;
    const config = {
        method: 'GET'
    }
...
const guardarPermiso = async e => {
    ...
    const url = "/inicio_pmlx/permisos/guardarAPI";
    const config = {
        method: 'POST',
        body
    }
...
const BuscarPermisos = async () => {
    const url = `/inicio_pmlx/permisos/buscarAPI`;
    const config = {
        method: 'GET'
    }
...
const ModificarPermiso = async (event) => {
    ...
    const body = new FormData(formPermiso);
    const url = '/inicio_pmlx/permisos/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarPermisos = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/inicio_pmlx/permisos/eliminar?id=${idPermiso}`;
        const config = {
            method: 'GET'
        }
