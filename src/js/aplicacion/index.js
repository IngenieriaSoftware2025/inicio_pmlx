...
const guardarAplicacion = async e => {
    ...
    const url = "/inicio_pmlx/aplicacion/guardarAPI";
    const config = {
        method: 'POST',
        body
    }
...
const BuscarAplicaciones = async () => {
    const url = `/inicio_pmlx/aplicacion/buscarAPI`;
    const config = {
        method: 'GET'
    }
...
const ModificarAplicacion = async (event) => {
    ...
    const body = new FormData(formAplicacion);
    const url = '/inicio_pmlx/aplicacion/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarAplicaciones = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/inicio_pmlx/aplicacion/eliminar?id=${idAplicacion}`;
        const config = {
            method: 'GET'
        }
...
BtnBuscarAplicaciones.addEventListener('click', MostrarTabla);