...
const guardarUsuario = async e => {
    ...
    const url = "/inicio_pmlx/usuarios/guardarAPI";
    const config = {
        method: 'POST',
        body
    }
...
const BuscarUsuarios = async () => {
    const url = `/inicio_pmlx/usuarios/buscarAPI`;
    const config = {
        method: 'GET'
    }
...
const ModificarUsuario = async (event) => {
    ...
    const body = new FormData(formUsuario);
    const url = '/inicio_pmlx/usuarios/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarUsuarios = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/inicio_pmlx/usuarios/eliminar?id=${idUsuario}`;
        const config = {
            method: 'GET'
        }
